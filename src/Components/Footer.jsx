      ...
      <div className="flex flex-col bg-[#191A23] mt-12 md:mx-10 md:rounded-t-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-full mb-8">
          <div className="text-white mb-8 ">
            <button className="bg-[#B9FF66] px-3 rounded-md text-black my-3 font-bold">
              Contact us:
            </button>
          ...
          <div className="bg-[#373841] flex flex-col md:flex-row md:w-fit p-5 mx-4 rounded-2xl md:items-center md:gap-5">
            <input
              className="border border-white rounded-md my-5 w-55 mx-auto md:w-auto h-10"
              type="text"
            />
            <button
              className="bg-[#B9FF66] text-black rounded-md w-55 mx-auto md:w-auto md:mx-0 my-1 md:my-0 cursor-pointer h-10 text-[12px] font-bold"
              type="submit"
            >
              Subscribe to news
            </button>
